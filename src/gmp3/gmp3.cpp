...
void GTP::GMP3::gmp3_set_tables(){
	...
	switch (sampling_rate) {
		case 8000:
			band_index.short_win = band_index_table.short_8;
			band_width.short_win = band_width_table.short_8;
			band_index.long_win = band_index_table.long_8;
			band_width.long_win = band_width_table.long_8;
			break;
		case 11000:
			band_index.short_win = band_index_table.short_11;
			band_width.short_win = band_width_table.short_11;
			band_index.long_win = band_index_table.long_11;
			band_width.long_win = band_width_table.long_11;
			break;
		case 12000:
			band_index.short_win = band_index_table.short_12;
			band_width.short_win = band_width_table.short_12;
			band_index.long_win = band_index_table.long_12;
			band_width.long_win = band_width_table.long_12;
			break;
		case 16000:
			band_index.short_win = band_index_table.short_16;
			band_width.short_win = band_width_table.short_16;
			band_index.long_win = band_index_table.long_16;
			band_width.long_win = band_width_table.long_16;
			break;
		case 22000:
			band_index.short_win = band_index_table.short_22;
			band_width.short_win = band_width_table.short_22;
			band_index.long_win = band_index_table.long_22;
			band_width.long_win = band_width_table.long_22;
			break;
		case 24000:
			band_index.short_win = band_index_table.short_24;
			band_width.short_win = band_width_table.short_24;
			band_index.long_win = band_index_table.long_24;
			band_width.long_win = band_width_table.long_24;
			break;
		case 32000:
