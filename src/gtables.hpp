/* sample rate for each mpeg version*/
const int SampleRate[3][3] = {
    { 44100, 48000, 32000 },		/* MPEG-1 */
    { 22050, 24000, 16000 },		/* MPEG-2 */
    { 11025, 12000,  8000 },		/* MPEG-2.5 */
};
/**/
const short BitRate[3][3][15] = {
	{
		/* MPEG-1 */
...
/**/
const short SamplesPerFrame[3][3] = {
	{ 384, 1152, 1152 },   /* MPEG1 */
	{ 384, 1152,  576 },   /* MPEG2 */
	{ 384, 1152,  576 }    /* MPEG2.5 */
};
/* layers 1, 2, 3 */
const short BitsPerSlot[3] = { 32, 8, 8 };

/* indexing = [version][mono/stereo]
 * number of bytes in side info section of bitstream
 */
const short SideBytes[3][2] = {
